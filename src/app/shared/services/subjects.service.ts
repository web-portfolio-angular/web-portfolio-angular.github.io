...
export class SubjectsService implements OnDestroy {
	...
	getCarLinksErrorMsgSubject = new BehaviorSubject<string>(null);
	getCarLinksErrorMsg: string = null;
	...
	constructor() {
		...
		this.getCarLinksErrorMsgSubject.next(this.getCarLinksErrorMsg);
	}
